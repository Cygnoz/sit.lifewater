...
//acoounts
router.post('/addaccounts', AccountsController.addAccount);
router.get('/getallaccounts', AccountsController.getAllAccount);
...
router.get('/get-one-trial-balance/:accountId',AccountsController.getOneTrailBalance)

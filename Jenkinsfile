pipeline {
    ...
    environment {
        ...
        ECS_SERVICE_NAME = 'lifewater-order' // Replace with your ECS service name
        ECS_TASK_DEFINITION_NAME = 'lifewater-order' // Replace with your ECS task definition name
    }

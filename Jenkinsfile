pipeline {
    ...
    environment {
        ...
        SONARQUBE_SCANNER_CREDENTIALS_ID = '5e0ce777-033a-4fac-99c3-94931e52c95e' // Jenkins credentials ID for SonarQube token        ECS_CLUSTER_NAME = 'lifewater-services' // Replace with your ECS cluster name

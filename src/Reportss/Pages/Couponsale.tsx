...
<div>
    ...
    <div className="flex justify-between items-center my-2 mx-2">
      <div>
        <h3 className="text-[#303F58] text-[20px] font-bold">Coupon Sale</h3>
            ...
            <table className="w-full text-left">
              <thead className=' bg-[#fdf8f0]'>
                <tr className="border-b">
                  ...
                  <th className="p-2 text-[12px] text-center text-[#303F58]">16 Leaf Coupon </th>
                  <th className="p-2 text-[12px] text-center text-[#303F58]">Discount</th>

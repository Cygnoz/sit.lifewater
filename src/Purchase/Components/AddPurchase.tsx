          ...
          <div className="flex-1 min-h-screen">
            ...
            <div className="container mx-auto p-4">
              <div className="bg-white p-4 -mt-1 -ms-2 rounded-lg shadow-md">
                ...
                {/* Add Item Section */}
                <div className="mb-4">
                  <h5 className="font-bold mb-2 text-[#202224] text-[16px]">
                    Add Item
                  </h5>
                  ...
                  <table className="w-full text-left">
                    <thead className=" bg-[#fdf8f0]">
                      <tr className="border-b">
                        <th className="p-2 text-[#495160] text-[12px] text-center font-medium">
                          Product
                        </th>
                        <th className="p-2 text-[#495160] text-[12px] text-center font-medium">
                          Quantity
                    ...
                    <tbody>
                      <tr className="border-b">
                        <td className="p-2 text-[#8F99A9] text-[14px] text-center font-normal">
                          <label className="text-[#8F99A9] text-[14px] font-normal">
                            Type or click
                          </label>
        ...
        <div>
              ...
              <label className="block mb-1 text-[14px] font-normal mt-1 text-[#4B5C79]">
                ...
                <div className="border-dashed border-2 border-neutral-300 p-2 rounded  gap-2 text-center h-[68px] mt-2">
                  <div className="flex gap-1 justify-center">
                    <img
                      className="text-[#4B5C79] w-[15px] h-[15px] mt-1"
                      src={upload}
                      alt=""
                    />
                    <span className="text-[12px] font-semibold mt-1 text-[#4B5C79]">
                      Upload File
                    </span>
                  </div>
          ...
          <div className="justify-center w-full h-[250px] p-6 rounded-lg shadow-md mt-5 bg-white">
            <div className="flex my-2">
              ...
              <h4 className="text-[#303F58] text-[14px] ms-56 font-normal">
                Rs 0.00
              </h4>
            </div>

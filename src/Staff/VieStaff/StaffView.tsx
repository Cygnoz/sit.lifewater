    ...
    return (
        <div>
            ...
            <div className="flex justify-between w-ful mt-1 mx-auto mb-5 pt-2 h-[52px] ps-5 pe-5 bg-white shadow-md rounded-lg ">
                <button
                    className={`flex px-9 py-2 h-[36px] rounded-lg text-center text-[14px] w-[221px] font-bold text-[#495160] ${activeTab === "personalDetails"
                ...
                <button
                    className={`flex px-10 py-2 h-[36px] rounded-lg text-center text-[14px] w-[221px] font-bold text-[#495160] ${activeTab === "orderHistory" ? "bg-[#E3E6D5] border-green-500" : ""
                        }`}
                ...
                <button
                    className={`flex px-7 py-2 h-[36px] rounded-lg text-center text-[14px] w-[221px] font-bold text-[#495160] ${activeTab === "paymentHistory"
                        ? "bg-[#E3E6D5] border-green-500"
                        : ""
                        }`}
                ...
                <button
                    className={`flex px-14 py-2 h-[36px] rounded-lg text-center text-[14px] w-[221px] font-bold text-[#495160] ${activeTab === "summary" ? "bg-[#E3E6D5] border-green-500" : ""
                        }`}
